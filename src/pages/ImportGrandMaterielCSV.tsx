...
import { GM_EXPECTED_FIELDS } from "../constants/expectedFields";
...
const STORAGE_KEY = "gm-column-mapping";


export default function GMImportCsvPage() {

    // ---------------------------------------------------------
    // State
    // ---------------------------------------------------------
    const expectedFields = GM_EXPECTED_FIELDS
    ...
    const missingRequired = GM_EXPECTED_FIELDS.filter(
        (field) =>
            field.required &&
