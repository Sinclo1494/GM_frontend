...
import { SOUS_FAMILLE_EXPECTED_FIELDS } from "../constants/expectedFields";
...
const STORAGE_KEY = "sous-famille-column-mapping";


export default function SousFamilleImportCsvPage() {

    // ---------------------------------------------------------
    // State
    // ---------------------------------------------------------
    const expectedFields = SOUS_FAMILLE_EXPECTED_FIELDS
    ...
    const missingRequired = SOUS_FAMILLE_EXPECTED_FIELDS.filter(
        (field) =>
            field.required &&
                ...
                <div className={components.card}>
                    ...
                    <div className={components.cardHeader}>
                        ...
                        <h1 className="text-xl font-bold text-gray-800">
                            Sous Familles Matériel - Import Des Données
                        </h1>
