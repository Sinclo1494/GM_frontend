...
import { FAMILLE_EXPECTED_FIELDS } from "../constants/expectedFields";
...
const STORAGE_KEY = "famille-column-mapping";


export default function FamilleImportCsvPage() {

    const expectedFields = FAMILLE_EXPECTED_FIELDS
    ...
    const missingRequired = FAMILLE_EXPECTED_FIELDS.filter(
        (field) =>
            field.required &&
                ...
                <div className={components.card}>
                    ...
                    <div className={components.cardHeader}>
                        ...
                        <h1 className="text-xl font-bold dark:text-dark-text-primary">
                            Familles Matériel - Import Des Données
                        </h1>
