...
import { POINTAGE_EXPECTED_FIELDS } from "../constants/expectedFields";
...
export default function PointageImportCsvPage() {

    // ---------------------------------------------------------
    // State
    // ---------------------------------------------------------
    const expectedFields = POINTAGE_EXPECTED_FIELDS
    ...
    const missingRequired = POINTAGE_EXPECTED_FIELDS.filter(
        (field) =>
            field.required &&
