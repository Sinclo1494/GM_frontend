...
import SousFamilleMaterielPage from "../../pages/SousFamilleMaterielPage";
...
describe("SousFamilleMaterielPage", () => {
  beforeEach(() => {
    resetAllMocks();
  });

  it("renders without crashing", () => {
    render(<SousFamilleMaterielPage />);
    expect(screen.getByTestId("crud-page")).toBeTruthy();
  });

  it("passes the correct title to CrudPage", () => {
    render(<SousFamilleMaterielPage />);
    expect(screen.getByTestId("crud-title").textContent).toBe("Sous-Familles Matériel");
  });

  it("passes the correct endpoint to CrudPage", () => {
    render(<SousFamilleMaterielPage />);
    expect(screen.getByTestId("crud-endpoint").textContent).toBe("sous-famille-materiel");
  });
