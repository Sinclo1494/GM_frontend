...
import RegularisationImportCsvPage from "../../pages/ImportRegularisationCSV";
...
describe("ImportRegularisationCSV", () => {
  beforeEach(() => {
    resetAllMocks();
    vi.clearAllMocks();
  ...
  it("renders without crashing", async () => {
    render(<RegularisationImportCsvPage />);
    expect(screen.getByText("Régularisation GM - Import Des Données")).toBeTruthy();
  });
