...
import FamilleMaterielPage from "../../pages/FamilleMaterielPage";
...
describe("FamilleMaterielPage", () => {
  beforeEach(() => {
    resetAllMocks();
  });

  it("renders without crashing", () => {
    render(<FamilleMaterielPage />);
    expect(screen.getByTestId("crud-page")).toBeTruthy();
  });

  it("passes the correct title to CrudPage", () => {
    render(<FamilleMaterielPage />);
    expect(screen.getByTestId("crud-title").textContent).toBe("Familles Matériel");
  });

  it("passes the correct endpoint to CrudPage", () => {
    render(<FamilleMaterielPage />);
    expect(screen.getByTestId("crud-endpoint").textContent).toBe("famille-materiel");
  });
