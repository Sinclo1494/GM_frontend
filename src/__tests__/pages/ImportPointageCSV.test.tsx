...
import PointageImportCsvPage from "../../pages/ImportPointageCSV";
...
describe("ImportPointageCSV", () => {
  ...
  it("renders without crashing", async () => {
    render(<PointageImportCsvPage />);
    expect(screen.getByText("Pointage Matériel - Import Des Données")).toBeTruthy();
  });
