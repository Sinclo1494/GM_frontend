...
import RegularisationGMPage from "../../pages/RegularisationGMPage";
...
describe("RegularisationGMPage", () => {
  beforeEach(() => {
    resetAllMocks();
  });

  it("renders without crashing", () => {
    render(<RegularisationGMPage />);
    expect(screen.getByTestId("crud-page")).toBeTruthy();
  });

  it("passes the correct title to CrudPage", () => {
    render(<RegularisationGMPage />);
    expect(screen.getByTestId("crud-title").textContent).toBe("Régularisations GM");
  });

  it("passes the correct endpoint to CrudPage", () => {
    render(<RegularisationGMPage />);
    expect(screen.getByTestId("crud-endpoint").textContent).toBe("regularisation-gm");
  });
