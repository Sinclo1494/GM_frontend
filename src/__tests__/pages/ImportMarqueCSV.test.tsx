...
import MarqueImportCsvPage from "../../pages/ImportMarqueCSV";

// Mock import services
vi.mock("../../api/importServices", () => ({
  validateMarque: vi.fn(),
  importMarque: vi.fn(),
}));
...
describe("ImportMarqueCSV", () => {
  ...
  it("renders without crashing", async () => {
    render(<MarqueImportCsvPage />);
    expect(screen.getByText("Marques Matériel - Import Des Données")).toBeTruthy();
  });
