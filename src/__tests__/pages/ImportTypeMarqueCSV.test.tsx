...
import TypeMarqueImportCsvPage from "../../pages/ImportTypeMarqueCSV";
...
describe("ImportTypeMarqueCSV", () => {
  ...
  it("renders without crashing", async () => {
    render(<TypeMarqueImportCsvPage />);
    expect(screen.getByText("Types Marques Matériel - Import Des Données")).toBeTruthy();
  });
