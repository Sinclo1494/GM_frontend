...
import SiteImportCsvPage from "../../pages/ImportSiteCSV";
...
describe("ImportSiteCSV", () => {
  ...
  it("renders without crashing", async () => {
    render(<SiteImportCsvPage />);
    expect(screen.getByText("Sites - Import Des Données")).toBeTruthy();
  });
