...
import TypeAffectationPage from "../../pages/TypeAffectationPage";
...
describe("TypeAffectationPage", () => {
  beforeEach(() => {
    resetAllMocks();
  });

  it("renders without crashing", () => {
    render(<TypeAffectationPage />);
    expect(screen.getByTestId("crud-page")).toBeTruthy();
  });

  it("passes the correct title to CrudPage", () => {
    render(<TypeAffectationPage />);
    expect(screen.getByTestId("crud-title").textContent).toBe("Types d'Affectation");
  });

  it("passes the correct endpoint to CrudPage", () => {
    render(<TypeAffectationPage />);
    expect(screen.getByTestId("crud-endpoint").textContent).toBe("type-affectation");
  });
