export const components = {
  button: {
    primary:
      "inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition dark:bg-blue-400 dark:hover:bg-blue-300",

    primaryLarge:
      "inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition dark:bg-blue-400 dark:hover:bg-blue-300",
  ...
  loginButton:
    "w-full inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-70 transition dark:bg-blue-400 dark:hover:bg-blue-300",
  ...
  select:
    "w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-800 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition dark:border-dark-border dark:bg-dark-input dark:text-dark-text-primary dark:focus:border-blue-400 dark:focus:ring-blue-200/50",
  ...
  pageTitle: "text-2xl font-bold text-dark dark:text-white",
  pageDescription: "text-sm text-dark dark:text-white mt-1",
  sectionTitle: "text-lg font-semibold text-blue-600 dark:text-blue-400",
